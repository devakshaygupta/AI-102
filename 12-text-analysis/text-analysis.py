...
def main():
    try:
        ...
        for file_name in os.listdir(reviews_folder):
            ...
            # Get entities
            entities_result = ai_client.recognize_entities(documents=[text])[0].entities
            print("Entities:")
            for entity in entities_result:
                print(f"  - {entity.text} ({entity.category}, {entity.subcategory}, Score: {entity.confidence_score})")
